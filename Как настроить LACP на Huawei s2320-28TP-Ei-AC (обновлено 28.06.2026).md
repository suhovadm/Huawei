...
1)	Если надо посмотреть прошивку коммута для гугления точного синтаксиса команд - пишем:  
...
5)	Если порты были настроены ранее и ругается, значит нужно очистить их. Для этого делаем следующее:  
...
10. И не забываем ещё разок засейвиться.  
