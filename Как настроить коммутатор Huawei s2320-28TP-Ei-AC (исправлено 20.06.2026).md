...
27)	Не забываем, что данная модель коммута имеет только 4 гигабитных порта и  
    подключаться нужно во 2-й жёлтый порт. Все синие (серые) порты по 100 mbps.  

29)	Что делать, если всё настроено, но PUTTY выдаёт ошибку:  
